...
AST_Node.prototype.size = function (compressor, stack) {
    ...
    walk_parent(this, (node, info) => {
        ...
        if (AST_Arrow.hasInstance(node) && node.is_braceless()) {
...
AST_Arrow.prototype._size = function () {
    ...
    if (
        !(
            ...
            && AST_Symbol.hasInstance(this.argnames[0])
        )
    ) {
        args_and_arrow += 2;
    }
...
AST_Binary.prototype._size = function (info) {
    ...
    if (
        ...
        && AST_Unary.hasInstance(this.right) && this.right.operator === this.operator
    ) {
